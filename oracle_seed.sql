...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE enderecos CASCADE CONSTRAINTS';
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE barbearias CASCADE CONSTRAINTS';
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE barbeiros CASCADE CONSTRAINTS';
...
CREATE TABLE horarios (
    id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    horario VARCHAR2 (5) NOT NULL -- Armazena no formato 'HH:MM'
);

INSERT INTO horarios (horario) VALUES ('09:00');

INSERT INTO horarios (horario) VALUES ('09:30');

INSERT INTO horarios (horario) VALUES ('10:00');

INSERT INTO horarios (horario) VALUES ('10:30');

INSERT INTO horarios (horario) VALUES ('11:00');

INSERT INTO horarios (horario) VALUES ('11:30');

INSERT INTO horarios (horario) VALUES ('12:00');

INSERT INTO horarios (horario) VALUES ('12:30');

INSERT INTO horarios (horario) VALUES ('13:00');

INSERT INTO horarios (horario) VALUES ('13:30');

INSERT INTO horarios (horario) VALUES ('14:00');

INSERT INTO horarios (horario) VALUES ('14:30');

INSERT INTO horarios (horario) VALUES ('15:00');

INSERT INTO horarios (horario) VALUES ('15:30');

INSERT INTO horarios (horario) VALUES ('16:00');

INSERT INTO horarios (horario) VALUES ('16:30');
...
INSERT INTO horarios (horario) VALUES ('18:30');
